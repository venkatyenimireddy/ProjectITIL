...
<div class="w3-card-4">
  ...
  <form method="post"  action="ticketType/${ticketId}" class="w3-container">
    <p>      
...
<c:forEach items="${ticketType}" var="choic">
<option name="ticketType" value="${choic.value}">${choic.key} </option>
</c:forEach>
</select>
    <p>
    <button class="w3-btn w3-brown">Submitt</button></p>
  </form>
</div>
</div>
